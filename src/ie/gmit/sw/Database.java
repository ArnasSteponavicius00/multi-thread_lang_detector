...
/**
 * Maps Languages to their ngrams and frequency.
...
public class Database {
	...
	/**
	 * Increment frequency of Language or reinsert into the map with a new entry.
	 * @param s kmer
	 * @param lang frequency of language
	 */
	...
	/**
	 * Sets the amount of entries in the Map.
	 * @param max Amount of top entries
	 */
	...
	/**
	 * Generate a temporary map and increment a Languages rank.
	 * @param max Limit of entry amount
	 * @param lang Language
	 * @return Top 300 kmers.
	 */
	...
	/**
	 * Compare query to the database of languages.
	 * @param query Query file
	 * @return Language closest to rank 0.
	 */
